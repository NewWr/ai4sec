...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "home.chip1": "Local-first",
    "home.chip2": "Evidence-cited",
    "home.chip3": "Multi-model",
    "home.panel_label": "Live analysis",
    "home.status.done": "Done",
    "home.status.active": "Running",
    "home.status.queued": "Queued",
    "home.flow_heading": "From PDF to lasting insight",
    "home.flow_sub": "A single pipeline takes a raw paper all the way to cited, reusable knowledge.",
    "home.flow.1.title": "Upload & parse",
    "home.flow.1.desc": "Drop in a PDF; MinerU extracts structured text, figures, and tables.",
    "home.flow.2.title": "Pick a mode",
    "home.flow.2.desc": "Snap, Lens, or Sphere — or let Smart Q&A route the question for you.",
    "home.flow.3.title": "Cited analysis",
    "home.flow.3.desc": "Every claim links back to the exact passage in the source PDF.",
    "home.flow.4.title": "Build knowledge",
    "home.flow.4.desc": "Distill cards, sync corpora, and reuse findings across papers.",
    ...
    "home.cta_band.title": "Ready to read smarter?",
    "home.cta_band.sub": "Turn your next paper into structured, cited insight in minutes.",
    ...
    "library.dataset_all": "All",
    "library.scope_all": "All corpora",
    "library.scope_graph": "Local graph",
    "library.ask_status.retrieve": "Retrieving corpus passages…",
    "library.ask_status.evidence": "Organizing evidence…",
    "library.ask_status.generate": "Generating cited answer…",
    "library.load_more": "Load more",
    "library.sources": "Sources",
    "library.history": "History",
    "library.history_empty": "No Q&A history yet.",
    "library.history_loading": "Loading history…",
    "library.history_search": "Search questions…",
    "library.history_cached": "Loaded from history.",
    "library.history_delete": "Delete",
    "library.history_deleted": "Deleted history item.",
    "library.answer_cached": "History answer",
    "library.answer_fresh": "New answer",
    "library.answer_time": "{seconds}s",
  ...
  zh: {
    ...
    "home.chip2": "证据引用",
    "home.chip3": "多模型",
    "home.panel_label": "实时分析",
    "home.status.done": "已完成",
    "home.status.active": "进行中",
    "home.status.queued": "排队中",
    "home.flow_heading": "从 PDF 到可沉淀的洞察",
    "home.flow_sub": "一条流水线把原始论文一路转化为带引用、可复用的知识。",
    "home.flow.1.title": "上传与解析",
    "home.flow.1.desc": "拖入 PDF，由 MinerU 提取结构化正文、图表与表格。",
    "home.flow.2.title": "选择模式",
    "home.flow.2.desc": "快速洞察、逻辑透镜或研究全景，也可让智能问答自动路由。",
    "home.flow.3.title": "带引用分析",
    "home.flow.3.desc": "每条结论都可回链到源 PDF 中的具体原文位置。",
    "home.flow.4.title": "沉淀知识",
    "home.flow.4.desc": "提炼知识卡片、同步语料，并在多篇论文间复用发现。",
    ...
    "home.cta_band.title": "准备好更聪明地读论文了吗？",
    "home.cta_band.sub": "几分钟内，把下一篇论文变成结构化、带引用的洞察。",
    ...
    "library.dataset_all": "全部",
    "library.scope_all": "全部语料库",
    "library.scope_graph": "本地图谱",
    "library.ask_status.retrieve": "正在检索语料库片段…",
    "library.ask_status.evidence": "正在组织证据…",
    "library.ask_status.generate": "正在生成带引用的答案…",
    "library.load_more": "加载更多",
    "library.sources": "来源",
    "library.history": "历史问答",
    "library.history_empty": "暂无问答记录。",
    "library.history_loading": "加载历史中…",
    "library.history_search": "搜索历史问题…",
    "library.history_cached": "已从历史记录加载。",
    "library.history_delete": "删除",
    "library.history_deleted": "已删除历史记录。",
    "library.answer_cached": "历史答案",
    "library.answer_fresh": "新生成",
    "library.answer_time": "{seconds} 秒",
